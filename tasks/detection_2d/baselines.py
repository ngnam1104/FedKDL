...
BASELINE_CONFIGS = {
    ...
    'scaffold':         BaselineConfig(full_param=True,  use_lora=False, use_int8=False, use_gateway_kd=False, scaffold=True, fedprox=True),
    'topk_grad':        BaselineConfig(full_param=True,  use_lora=False, use_int8=False, use_gateway_kd=False, topk_grad=True),
    'topk_grad_10':     BaselineConfig(full_param=True,  use_lora=False, use_int8=False, use_gateway_kd=False, topk_grad=True, topk_ratio=0.10),
    'topk_grad_20':     BaselineConfig(full_param=True,  use_lora=False, use_int8=False, use_gateway_kd=False, topk_grad=True, topk_ratio=0.20),
