...
class Simulator1D(BaseSimulator):
    def __init__(self, topo_path: str, data_path: str, baseline: str, device: str = "cpu"):
        ...
        # Build dataloaders
        train_data, train_labels, val_data, val_labels, test_data, test_labels = load_dataset(self.dataset_name, seed=data_part.seed)
    ...
    def evaluate(self) -> Dict[str, float]:
        ...
        pa_f1, prec, rec, f1_std, prec_std, rec_std = point_adjusted_f1(np.array(test_labels), np.array(test_errors), tau_A)
        ...
        return {
            ...
            'Prec-Std': prec_std, 'Rec-Std': rec_std,
