...
from plot_common import LABELS, T, load_learning, load_summary, save, setup_style
...
accuracy_bars = accuracy_axis.bar(
    ...
    color="#E8A15B",
    edgecolor="black",
    label=T("Best mAP@0.5"),
)

labels = [LABELS[method] if method != "fedkdl" else T("FedKDL-Nearest") for method in methods]
ax.set_xticks(x, labels)
ax.set_xlabel(T("Relay Cooperation Strategy"))
ax.set_ylabel(T("Joint Objective Cost"))
accuracy_axis.set_ylabel(T("Mean Average Precision"))
...
ax.legend(
    ...
    [T("Joint Objective Cost"), T("Best mAP@0.5")],
    loc="upper center",
    ncol=2,
)
