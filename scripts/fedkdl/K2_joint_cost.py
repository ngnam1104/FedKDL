...
from plot_common import LABELS, T, load_summary, plot_mean_std, save, setup_style
...
axes[0].set(xlabel=T("Number of AUVs"), ylabel=T("Joint Objective Cost"))
...
axes[1].set_xlabel(T("Baseline Method"))
axes[1].set_ylabel(T("Cost Contribution at N=60"))
axes[1].legend()
