...
def draw(lang: str) -> None:
    ...
    axes[0].set_title(T("(a)", lang) + " " + T("Compression-Method Learning Curves", lang), loc="center", fontweight="bold")

    # ── (b) Grouped cost bars: Loss | Energy | Latency (normalized) ──────────
    grouped_cost_bars(axes[1], KEYS, lang, legend_loc="upper center", bbox_to_anchor=(0.5, -0.24), ncol=3)
