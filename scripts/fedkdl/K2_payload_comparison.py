...
ax1.set_xlabel(T("Compression / PEFT Method"))
ax1.set_ylabel(T("Transmission Payload per AUV (MB)"))
ax2.set_ylabel(T("Mean Average Precision (mAP@0.5)"))
...
ax1.legend(
    [bar1, bar2],
    [T("Payload per AUV (MB)"), T("Best mAP@0.5")],
    loc="upper center",
